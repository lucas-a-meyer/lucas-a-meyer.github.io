...
description: The intricacies of automatically locking computers when not in use, the
  problem of device detection, the function of Bluetooth in addressing this issue,
  and the comparison of this problem to automatic flushing systems in urinals.
draft: true
