...
- **An attention test called [IVA-AE2](https://www.braintrain.com/ivaae2/)** that simultaneously shows an image of a number and speaks another number. For example, it can show 2 and speak "six". You are assigned two different target numbers, one to click when you see it and another to click when you hear it. It then speaks and shows numbers for 20 minutes. I think it's pretty normal to make the mistake of clicking when you hear the number you're supposed to click only when you see and vice-versa, and I'm sure I made plenty of mistakes, but I think most people would. This test was very tiring.
