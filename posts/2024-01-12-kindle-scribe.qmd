...
I recently replaced my [reMarkable 2](2023-12-31-remarkable2.qmd) e-tablet by a [Kindle Scribe](https://amzn.to/4aOKq33). The Kindle Scribe solves a couple more of the use cases that are important to me, which I will describe below.
...
Although the reMarkable 2 worked ok for me, one of the problems I found in my [review](2023-12-31-remarkable2.qmd) was that it was not great for reading PDFs. The main problem for me was the lack of a backlight, which made it hard to read in low light conditions, and even in somewhat normal conditions — the contrast is not very good and not adjustable. The Kindle Scribe solves this problem. 
