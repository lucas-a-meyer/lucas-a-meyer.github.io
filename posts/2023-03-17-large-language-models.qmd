...
image: https://mpsocial.blob.core.windows.net/blog-images/ai_schnauzer.png
include-in-header: _msft-clarity.html
linkedin-target-date: 2023-03-20 06:00:00
title: How to Use Stable Diffusion from Hugging Face
twitter-target-date: 2023-03-20 06:00:00
---
...
The `generate` method will return a PIL image object that you can display or save as you wish. You can also customize some parameters of the generation process, such as the number of samples, the resolution, and the number of diffusion steps. For more details, please refer to the documentation of Diffusers (https://huggingface.co/docs/diffusers/index).
