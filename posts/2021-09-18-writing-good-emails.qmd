...
description: Efficient email handling techniques, including clearly identifying owners
  for questions or actions, keeping owners on the 'to:' line, not forking threads
  with actions, and placing actions at the end of the email.
