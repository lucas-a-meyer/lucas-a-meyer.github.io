...
The number 42 also appeeared in Doctor Who, Star Trek and The X-Files. Once the number made its way into literature and other media liked by scientists, it would not take long until it was used in computer science. 
...
In 2016, the software engineer Aleksey Bilogur published a blog post analyzing GitHub and searching for the most used random seeds. The results: 0 was the most used seed, with 40% of the results, with 42 coming in second with 17.3% of the results, folowed by 1 with 16.8%, 1234 with 4.14% and 123 with 1.75%.

## Do you like Wikipedia?

In the book, the Guide is a competitor to the Encyclopedia Galactica, which is a repository of all knowledge in the universe. The Guide, instead of being written by experts, can comically be edited by anyone. The big advantage of the Guide, which accounts for most of its success, it's that it's slightly cheaper. Presciently, that is similar to the way Wikipedia works.
